...
- Except for the chemical potential and Seebeck coefficient, these were created for future expansion and should be used as a reference only. Various functional expansions will be implemented after new project applications are approved.
