...
- The temperature dependence of the thermal conductivity is calculated using the Cezairliyan treatment of "Thermal Conductivity of Elements [13]", where the code assumes that Tm = Debye temperature and km is the thermal conductivity at the Debye temperature.
