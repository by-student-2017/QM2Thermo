...
# Strain values to apply (Note: strain_values/acell*100 [%])
#strain_values=(-0.024 -0.022 -0.020 -0.018 -0.016 -0.014 -0.012 -0.010 -0.008 -0.006 -0.004 -0.002
#        +0.000 +0.002 +0.004 +0.006 +0.008 +0.010 +0.012 +0.014 +0.016 +0.018 +0.020 +0.022 +0.024)
#--------------
#strain_values=(-0.024 -0.020 -0.016 -0.012 -0.008 -0.004
#        +0.000 +0.004 +0.008 +0.012 +0.016 +0.020 +0.024)
#--------------
#strain_values=(-0.024 -0.018 -0.012 -0.006
#        +0.000 +0.006 +0.012 +0.018 +0.024)
#--------------
#strain_values=(-0.024 -0.016 -0.008
#        +0.000 +0.008 +0.016 +0.024)
#--------------
strain_values=(-0.040 -0.030 -0.020 -0.010
