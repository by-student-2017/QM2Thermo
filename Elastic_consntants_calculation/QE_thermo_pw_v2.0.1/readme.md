# QE v7.3.1 + thermo_pw v2.0.1

## QE v7.3.1 Installation
1. sudo apt update
...
5. tar xvf qe-7.3.1.tar.gz
6. cd q-e-qe-7.3.1
7. ./configure
8. make pwall
9. sudo make install

## thermo_pw v2.0.1 Installation for QE v7.3.1
1. cd q-e-qe-7.3.1
2. wget https://github.com/dalcorso/thermo_pw/archive/refs/tags/2.0.1.tar.gz
3. tar -xvzf 2.0.1.tar.gz
4. mv thermo_pw-2.0.1 thermo_pw
5. cd thermo_pw
6. make join_qe
7. cd ..
8. ./configure
...
```
    ...
    i j=        1           2           3           4           5           6
    1  1543.12082   567.35125   567.35125     0.00000     0.00000     0.00000
    2   567.35125  1543.12082   567.35125     0.00000     0.00000     0.00000
    3   567.35125   567.35125  1543.12082     0.00000     0.00000     0.00000
    4     0.00000     0.00000     0.00000   766.93679     0.00000     0.00000
    5     0.00000     0.00000     0.00000     0.00000   766.93679     0.00000
    6     0.00000     0.00000     0.00000     0.00000     0.00000   766.93679
    ...
    6     0.00000     0.00000     0.00000     0.00000     0.00000     1.30389
     ...
     Voigt approximation:
     Bulk modulus  B =    892.60777 kbar
     Young modulus E =   1579.43032 kbar
     Shear modulus G =    655.31599 kbar
     Poisson Ratio n =      0.20509
     Pugh Ratio r =         0.73416

     Reuss approximation:
     Bulk modulus  B =    892.60777 kbar
     Young modulus E =   1518.49805 kbar
     Shear modulus G =    624.14229 kbar
     Poisson Ratio n =      0.21647
     Pugh Ratio r =         0.69923

     Voigt-Reuss-Hill average of the two approximations:
     Bulk modulus  B =    892.60777 kbar
     Young modulus E =   1548.96419 kbar
     Shear modulus G =    639.72914 kbar
     Longitudinal modulus L =   1745.57996 kbar
     Poisson Ratio n =      0.21064
     Pugh Ratio r =         0.71670

     Voigt-Reuss-Hill average; sound velocities:

     Compressional V_P =     8747.674 m/s
     Bulk          V_B =     6255.371 m/s
     Shear         V_G =     5295.669 m/s

     The approximate Debye temperature is      637.299 K

                    ----------------------------------------

     Average Debye sound velocity =     5827.178 m/s
